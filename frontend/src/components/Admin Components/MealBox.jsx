...
const MealBox = ({ title, data }) => {
    ...
    return (
        <div className="bg-stubgcard p-4 rounded-md flex-1 transform transition duration-300 hover:scale-105 border-1 border-gray-700 shadow-md shadow-gray-700">
            ...
            <p className="text-lg font-medium mb-2 text-gray-200">⭐ {average} average</p>
            {[5, 4, 3, 2, 1].map(star => (
                <div key={star} className="flex items-center text-sm mb-1 text-gray-200">
