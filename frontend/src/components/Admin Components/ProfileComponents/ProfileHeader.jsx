export default function AdminProfileHeader({profileImage, handleImageChange, userData, isEditing, handleEdit, handleSave, handleCancel}){
    return (
        ...
        <div className="flex flex-col items-center space-y-4 md:flex-row md:items-center md:space-x-10">
          ...
          <div>
            ...
            <p className="text-sm text-gray-100">{userData.position}</p>
