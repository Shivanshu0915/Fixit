export default function AdminProfileInfo({userData, isEditing, handleChange}) {
    return (
        <div className="w-full max-w-4xl bg-profileboxbg rounded-lg shadow-md mb-6 border-1 border-profileborder">
            <h2 className="text-lg text-dashtext font-semibold flex gap-x-2 items-center border-b-2 border-profileborder py-5 px-7">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm py-8 px-7">
                ...
                <div>
                    <label className="block text-profileboxtext1 mb-2 font-semibold">DEPARTMENT</label>
                    <input
                        type="text"
                ...
                <div className="">
                    <label className="block text-profileboxtext1 mb-2 font-semibold">POSITION</label>
                    <input
                        type="text"
