export default function AdminProfileSettings({setShowModal, logoutHandler}) {
    return (
        <div className="w-full max-w-4xl grid md:grid-cols-2 gap-6 md:gap-4">
            {/* Security */}
            <div className="bg-gray-800 rounded-lg shadow-md">
                <h3 className="text-lg flex items-center font-semibold gap-x-2 border-b-2 border-gray-700 py-5 px-6">
            ...
            {/* Preferences */}
            <div className="bg-[#1e293b] rounded-lg shadow-md">
                <h3 className="text-lg flex items-center font-semibold gap-x-2 border-b-2 border-gray-700 py-5 px-6">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white"><path d="M480-120q-150 0-255-105T120-480q0-150 105-255t255-105q14 0 27.5 1t26.5 3q-41 29-65.5 75.5T444-660q0 90 63 153t153 63q55 0 101-24.5t75-65.5q2 13 3 26.5t1 27.5q0 150-105 255T480-120Zm0-80q88 0 158-48.5T740-375q-20 5-40 8t-40 3q-123 0-209.5-86.5T364-660q0-20 3-40t8-40q-78 32-126.5 102T200-480q0 116 82 198t198 82Zm-10-270Z" /></svg>
                    Preferences
                </h3>
