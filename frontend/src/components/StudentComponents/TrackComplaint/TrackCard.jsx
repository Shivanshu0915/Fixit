...
export function TrackCard({ props }) {
    ...
    return (
        <div className="bg-stubgcard w-full h-auto px-3 py-2 rounded-lg shadow-sm shadow-gray-700">
            {/* Author details  */}
            <div className="w-full flex flex-wrap justify-between items-center gap-y-2 border-b-[1px] border-gray-500">
                <div className="text-[#b9babb] text-lg px-2 pt-1 pb-2 bg-stubgcard min-w-0 truncate">
                    {student.name.split(" ")
...
export default function StatBox({ label, value, color = 'text-white' }) {
    return (
        <div className="bg-gray-800 rounded-lg py-5 px-[7%] border-gray-700 border-1">
            <p className="text-sm text-gray-400 py-1">{label}</p>
